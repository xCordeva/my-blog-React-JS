    ...
    <div className="nav-container">
      <div className={`nav-bar ${isTransparent ? "transparent" : ""}`}>
        <div className="nav-left-side hero-container">
          <Link to="/">
            <h2 className="hero glitch layers" data-text="The Cordeva Blog">
              <span>The Cordeva Blog</span>
            </h2>
          </Link>
        </div>
        <div className="nav-right-side">
          <div className="desktop-menu">
            <Link
              to="/"
              className={
                location.pathname === "/" ? "current-page" : "not-current-page"
              }
            >
              Home
            </Link>
            <Link
              to="https://xcordeva.github.io/"
              target="_blank"
              className={
            ...
            <div className="dark-light-mode" onClick={() => modeHandler()}>
              ...
              <i className="mode-icon">
                <img
                  src={
                    modeChanger
                      ? require(`${`./images/earlybird.png`}`)
                      : require(`${`./images/owl.png`}`)
                  }
                  alt="owl"
                  className="owl-no-eyes"
                  style={{ width: modeChanger ? "40px" : "20px" }}
                />
                <img
                  src={
                    modeChanger
                      ? require(`${`./images/earlybird-shine.png`}`)
                      : require(`${`./images/owlEyes.png`}`)
                  }
                  alt="owl-eyes"
                  className="owl-eyes"
                  style={{ width: modeChanger ? "40px" : "20px" }}
